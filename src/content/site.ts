export const siteContent = {
  ...
  privacy: {
    // Replace this draft with your actual mailbox/provider retention practice before publishing.
    retention:
      "[DRAFT: Confirm how long enquiry emails and provider delivery records are retained, who manages deletion, and how a person can request deletion.]",
  },
} as const;
